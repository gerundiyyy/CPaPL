...
public class FrameManager extends JFrame{
    ...
    public void onRead() {
        ...
        int ret = fileopen.showDialog(FrameManager.this, "Open file for reading" );
    ...
    public void onWrite() {
        JFileChooser fileopen = new JFileChooser();
        int ret = fileopen.showDialog(FrameManager.this, "Write to file" );
        if (ret == JFileChooser.APPROVE_OPTION) {
            File file = fileopen.getSelectedFile();
            ...
            try {
                ...
                showError("Error of writing file" + ex.getMessage());
            }
        }
    }
    ...
    public void parseFile(File file){
        ...
        if (!list.isEmpty()) {
            ...
            showError("The file was read, but no records were found.");
        }
    }
